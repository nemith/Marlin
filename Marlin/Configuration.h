...
#define STRING_CONFIG_H_AUTHOR "(Brandon Bennett, Dual Hybrid)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bigbox v1.1 Dual Hybrid Titan"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 180, 1600, 417.5, 417.5 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  70, 200, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { 70, 235, (Z_MIN_POS + 1) } }
